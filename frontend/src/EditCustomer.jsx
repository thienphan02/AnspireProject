        ...
        <div className='d-flex flex-column align-items-center pt-4'>
			...
			<div className ="col-12">
				...
				<div className ="col-12">
					...
					onChange={e => setData({...data, DevicePaymentPlan: e.target.value})} value={data.device_payment_plan}/>
				</div>
                <div className ="col-12">
					...
					onChange={e => setData({...data, CreditCardNumber: e.target.value})} value={data.credit_card}/>
				</div>
                <div className ="col-12">
					...
					onChange={e => setData({...data, CreditCardType: e.target.value})} value={data.credit_card_type}/>
				</div>
                <div className ="col-12">
					...
					onChange={e => setData({...data, AccountLastPayment: e.target.value})} value={data.account_last_payment_date}/>
				</div>
				<div className ="col-12">
                ...
                <div className ="col-12">
					...
					onChange={e => setData({...data, PostalCode: e.target.value})} value={data.postal_code}/>
				</div>
				<div className ="col-12">
